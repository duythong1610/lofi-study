...
const ScreenListComponent = ({
  ...
  return (
    <div>
      {toggleScreen && (
        <div className="pl-4 py-4 absolute flex flex-col gap-4 top-0 bottom-0 left-[calc(5%+35px)] lg:left-[calc(5%+50px)] m-auto rounded-xl bg-black/60 max-h-[90%] lg:max-h-[600px] backdrop-blur-sm z-20">
