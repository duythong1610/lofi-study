...
const OptionsComponent = ({
  ...
  return (
    <div>
      {isShowOptions && (
        <FloatButton.Group className="bg-black/60 backdrop-blur-md left-[10vw] md:left-[5%] lg:left-[5%] flex flex-col justify-around rounded-2xl p-1 lg:p-2 w-fit h-fit top-1/2 -translate-x-[50%] -translate-y-[50%] mb-0">
